...
import com.bec.cloud.baodanxitong.web.customer.service.crud.CustContractService;
...
public class CustContractServiceImpl implements CustContractService {
	...
	@Override
	public List<CustContract> selectCustContracts(CustContract record) {
		return mapper.selectCustContracts(record);
	}
